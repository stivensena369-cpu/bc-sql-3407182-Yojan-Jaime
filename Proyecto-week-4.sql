-- ============================================
-- PROYECTO SEMANAL: DML de Escape Room
-- Base para Semana 04
-- ============================================
...
SELECT
    ...
    max_players AS "Máximo de jugadores"
FROM rooms;

-- ============================================
-- CONSULTA 2
-- Mostrar únicamente las salas difíciles
-- ============================================
...
SELECT
    ...
    name AS "Sala",
    difficulty AS "Dificultad",
    max_players AS "Capacidad"
FROM rooms
WHERE difficulty = 'hard';

-- ============================================
-- CONSULTA 3
-- Salas difíciles para 6 o más jugadores
-- ============================================
...
-- ============================================
-- CONSULTA 4
-- Top 5 salas con mayor capacidad
-- ============================================
